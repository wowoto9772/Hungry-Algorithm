...
//							a = 1000000 + I[i].x;
//							x[a]++;
//							if (ans > x[a] + 1)ans = x[a] + 1;
//						}
//						else if (I[i].y == I[j].y){
//							a = 1000000 + I[i].y;
//							y[a]++;
//							if (ans > y[a] + 1)ans = y[a] + 1;
//						}
//						else{
//							long long flag = (I[i].x - I[j].x);
//							flag *= (I[i].y - I[j].y);
//							if (flag > 0){
//								S[top2].flag = 1;
//							}
...
//							}
//
//							int ax = ab(I[i].x - I[j].x);
//							int ay = ab(I[i].y - I[j].y);
//
//							int g = GCD(ax, ay);
//
//							ax /= g;
...
//							if (S[i].mx == S[j].mx && S[i].my == S[j].my){
//								if (S[i].y == S[j].y){
//									p = j;
//									c++;
//								}
